...
- [ ] 18.1 [PBT] Propiedad 1: Solo países habilitados se programan — `ConfigurationPropertyTests.cs` (Feature: unified-monitoring-service, Property 1)
- [ ] 18.2 [PBT] Propiedad 2: Cada ciclo produce ambos tipos de certificación — `MonitoringOrchestratorPropertyTests.cs` (Feature: unified-monitoring-service, Property 2)
- [ ] 18.3 [PBT] Propiedad 3: Inyección de campos dinámicos en plantillas XML — `CertificationPropertyTests.cs` (Feature: unified-monitoring-service, Property 3)
- [ ] 18.4 [PBT] Propiedad 4: Invariante de construcción de MonitoringResult — `MonitoringResultPropertyTests.cs` (Feature: unified-monitoring-service, Property 4)
- [ ] 18.5 [PBT] Propiedad 5: Unicidad de consecutivos atómicos — `CertificationPropertyTests.cs` (Feature: unified-monitoring-service, Property 5)
- [ ] 18.6 [PBT] Propiedad 6: Round-trip de persistencia en PostgreSQL — `PostgresPropertyTests.cs` (Feature: unified-monitoring-service, Property 6)
- [ ] 18.7 [PBT] Propiedad 7: Lógica de disparo de notificaciones con control manual — `NotificationPropertyTests.cs` (Feature: unified-monitoring-service, Property 7)
- [ ] 18.8 [PBT] Propiedad 8: Completitud y validez del contenido de notificaciones — `NotificationPropertyTests.cs` (Feature: unified-monitoring-service, Property 8)
- [ ] 18.9 [PBT] Propiedad 9: Enmascaramiento de credenciales en logs — `SecurityPropertyTests.cs` (Feature: unified-monitoring-service, Property 9)
- [ ] 18.10 [PBT] Propiedad 10: Validación de CountryConfig — `ConfigurationPropertyTests.cs` (Feature: unified-monitoring-service, Property 10)
- [ ] 18.11 [PBT] Propiedad 11: Completitud de logs estructurados — `LoggingPropertyTests.cs` (Feature: unified-monitoring-service, Property 11)
- [ ] 18.12 [PBT] Propiedad 12: Correctitud de retención de datos — `RetentionPropertyTests.cs` (Feature: unified-monitoring-service, Property 12)
- [ ] 18.13 [PBT] Propiedad 13: Cooldown de notificaciones previene spam — `NotificationGatePropertyTests.cs` (Feature: unified-monitoring-service, Property 13)
- [ ] 18.14 [PBT] Propiedad 14: Monitoreo continúa independiente de flags de notificación — `NotificationGatePropertyTests.cs` (Feature: unified-monitoring-service, Property 14)
